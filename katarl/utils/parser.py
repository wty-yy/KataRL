...
class Parser(ArgumentParser):
    ...
    def __init__(self, algo_name='dqn', env_name='CartPole-v1', model_name='tf_mlp'):
        ...
        self.add_argument("--fps", type=int, default=30,
            help="the frame per second(fps) of the capture video")
    ...
    def get_args_and_writer(self) -> tuple[NamedTuple, SummaryWriter]:
        ...
        args.load_name, args.load_id = None, None
        if isinstance(args.train, list):
            if len(args.train) == 0: args.train = True
                ...
                args.load_name, args.load_id = args.train
        ...
        args.run_name = f"{args.algo_name}__{args.env_name}__{args.model_name}__{args.seed}__{get_time_str()}".replace("/", "-")
        self.args = args
        self.init_wandb()
